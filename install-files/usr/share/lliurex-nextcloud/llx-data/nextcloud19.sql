...
INSERT INTO `oc_appconfig` VALUES ('accessibility','enabled','yes'),('accessibility','installed_version','1.5.0'),('accessibility','types',''),('activity','enabled','yes'),('activity','installed_version','2.12.0'),('activity','types','filesystem'),('backgroundjob','lastjob','34'),('bruteforcesettings','enabled','yes'),('bruteforcesettings','installed_version','1.6.0'),('bruteforcesettings','types',''),('calendar','enabled','yes'),('calendar','installed_version','2.0.3'),('calendar','types',''),('cloud_federation_api','enabled','yes'),('cloud_federation_api','installed_version','1.2.0'),('cloud_federation_api','types','filesystem'),('comments','enabled','yes'),('comments','installed_version','1.9.0'),('comments','types','logging'),('contacts','enabled','yes'),('contacts','installed_version','3.3.0'),('contacts','types',''),('contactsinteraction','enabled','yes'),('contactsinteraction','installed_version','1.0.0'),('contactsinteraction','types','dav'),('core','installed.bundles','[\"CoreBundle\"]'),('core','installedat','1594900576.1584'),('core','lastcron','1594967976'),('core','lastupdateResult','[]'),('core','lastupdatedat','1594903597'),('core','oc.integritycheck.checker','[]'),('core','public_files','files_sharing/public.php'),('core','public_webdav','dav/appinfo/v1/publicwebdav.php'),('core','theming.variables','d41d8cd98f00b204e9800998ecf8427e'),('core','vendor','nextcloud'),('dav','enabled','yes'),('dav','installed_version','1.15.0'),('dav','types','filesystem'),('federatedfilesharing','enabled','yes'),('federatedfilesharing','installed_version','1.9.0'),('federatedfilesharing','types',''),('federation','autoAddServers','1'),('federation','enabled','yes'),('federation','installed_version','1.9.0'),('federation','types','authentication'),('files','cronjob_scan_files','500'),('files','enabled','yes'),('files','installed_version','1.14.0'),('files','types','filesystem'),('files_pdfviewer','enabled','yes'),('files_pdfviewer','installed_version','1.8.0'),('files_pdfviewer','types',''),('files_rightclick','enabled','yes'),('files_rightclick','installed_version','0.16.0'),('files_rightclick','types',''),('files_sharing','enabled','yes'),('files_sharing','installed_version','1.11.0'),('files_sharing','types','filesystem'),('files_trashbin','enabled','yes'),('files_trashbin','installed_version','1.9.0'),('files_trashbin','types','filesystem,dav'),('files_versions','enabled','yes'),('files_versions','installed_version','1.12.0'),('files_versions','types','filesystem,dav'),('files_videoplayer','enabled','yes'),('files_videoplayer','installed_version','1.8.0'),('files_videoplayer','types',''),('firstrunwizard','enabled','yes'),('firstrunwizard','installed_version','2.8.0'),('firstrunwizard','types','logging'),('logreader','enabled','yes'),('logreader','installed_version','2.4.0'),('logreader','types',''),('lookup_server_connector','enabled','yes'),('lookup_server_connector','installed_version','1.7.0'),('lookup_server_connector','types','authentication'),('mail','enabled','no'),('mail','installed_version','1.4.1'),('mail','types',''),('nextcloud_announcements','enabled','no'),('nextcloud_announcements','installed_version','1.8.0'),('nextcloud_announcements','pub_date','Thu, 24 Oct 2019 00:00:00 +0200'),('nextcloud_announcements','types','logging'),('notifications','enabled','yes'),('notifications','installed_version','2.7.0'),('notifications','types','logging'),('oauth2','enabled','yes'),('oauth2','installed_version','1.7.0'),('oauth2','types','authentication'),('password_policy','enabled','yes'),('password_policy','installed_version','1.9.1'),('password_policy','types','authentication'),('photos','enabled','yes'),('photos','installed_version','1.1.0'),('photos','types',''),('privacy','enabled','yes'),('privacy','installed_version','1.3.0'),('privacy','types',''),('provisioning_api','enabled','yes'),('provisioning_api','installed_version','1.9.0'),('provisioning_api','types','prevent_group_restriction'),('recommendations','enabled','yes'),('recommendations','installed_version','0.7.0'),('recommendations','types',''),('richdocuments','disable_certificate_verification',''),('richdocuments','enabled','no'),('richdocuments','installed_version','3.7.3'),('richdocuments','types','filesystem,dav,prevent_group_restriction'),('richdocuments','wopi_url','https://nextcloud/apps/richdocumentscode/proxy.php?req='),('richdocumentscode','enabled','no'),('richdocumentscode','installed_version','4.2.503'),('richdocumentscode','types',''),('serverinfo','enabled','yes'),('serverinfo','installed_version','1.9.0'),('serverinfo','types',''),('settings','enabled','yes'),('settings','installed_version','1.1.0'),('settings','types',''),('sharebymail','enabled','yes'),('sharebymail','installed_version','1.9.0'),('sharebymail','types','filesystem'),('spreed','enabled','yes'),('spreed','has_reference_id','yes'),('spreed','installed_version','9.0.1'),('spreed','start_calls','2'),('spreed','start_conversations','[]'),('spreed','stun_servers','[\"stun.nextcloud.com:443\"]'),('spreed','types','prevent_group_restriction'),('support','enabled','no'),('support','installed_version','1.2.1'),('support','types','session'),('survey_client','apps','no'),('survey_client','database','no'),('survey_client','enabled','no'),('survey_client','encryption','no'),('survey_client','files_sharing','no'),('survey_client','installed_version','1.7.0'),('survey_client','php','no'),('survey_client','server','no'),('survey_client','stats','no'),('survey_client','types',''),('systemtags','enabled','yes'),('systemtags','installed_version','1.9.0'),('systemtags','types','logging'),('text','enabled','yes'),('text','installed_version','3.0.1'),('text','types','dav'),('theming','enabled','no'),('theming','installed_version','1.10.0'),('theming','types','logging'),('twofactor_backupcodes','enabled','yes'),('twofactor_backupcodes','installed_version','1.8.0'),('twofactor_backupcodes','types',''),('updatenotification','enabled','no'),('updatenotification','installed_version','1.9.0'),('updatenotification','types',''),
('user_ldap','cleanUpJobOffset','0'),
('user_ldap','enabled','yes'),
('user_ldap','installed_version','1.9.0'),
('user_ldap','s01_lastChange','1594902307'),
...
('user_ldap','types','authentication'),('viewer','enabled','yes'),('viewer','installed_version','1.3.0'),('viewer','types',''),('workflowengine','enabled','yes'),('workflowengine','installed_version','2.1.0'),('workflowengine','types','filesystem');
...
INSERT INTO `oc_calendars` VALUES (1,'principals/system/system','Contact birthdays','contact_birthdays',1,NULL,0,'#E9D859',NULL,'VEVENT',0),(3,'principals/users/alu02','Personal','personal',1,NULL,0,NULL,NULL,'VEVENT,VTODO',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=642 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oc_filecache` (
  ...
  KEY `fs_mtime` (`mtime`)
) ENGINE=InnoDB AUTO_INCREMENT=631 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oc_jobs` VALUES (1,'OCA\\Files_Trashbin\\BackgroundJob\\ExpireTrash','null',1594966657,1594966657,0,0),(2,'OCA\\Files_Sharing\\DeleteOrphanedSharesJob','null',1594966725,1594966725,0,0),(3,'OCA\\Files_Sharing\\ExpireSharesJob','null',1594900835,1594967213,0,0),(4,'OCA\\Files_Sharing\\BackgroundJob\\FederatedSharesDiscoverJob','null',1594900846,1594967294,0,0),(6,'OCA\\Activity\\BackgroundJob\\EmailNotification','null',1594967326,1594967326,0,0),(7,'OCA\\Activity\\BackgroundJob\\ExpireActivities','null',1594900901,1594967349,0,0),(8,'OCA\\WorkflowEngine\\BackgroundJobs\\Rotate','null',1594967398,1594967398,0,0),(9,'OCA\\UpdateNotification\\Notification\\BackgroundJob','null',1594900911,1595010644,0,0),(10,'OCA\\Federation\\SyncJob','null',1594900916,1594967444,0,0),(11,'OCA\\Text\\Cron\\Cleanup','null',1594967489,1594967489,0,0),(12,'OCA\\ContactsInteraction\\BackgroundJob\\CleanupJob','null',1594967507,1594967507,0,0),(13,'OCA\\Files_Versions\\BackgroundJob\\ExpireVersions','null',1594967523,1594967523,0,0),(14,'OCA\\DAV\\BackgroundJob\\CleanupDirectLinksJob','null',1594901005,1594967546,0,0),(15,'OCA\\DAV\\BackgroundJob\\UpdateCalendarResourcesRoomsBackgroundJob','null',1594967555,1594967555,0,0),(16,'OCA\\DAV\\BackgroundJob\\CleanupInvitationTokenJob','null',1594901038,1594967733,0,0),(17,'OCA\\DAV\\BackgroundJob\\EventReminderJob','null',1594967746,1594967746,0,0),(18,'OCA\\NextcloudAnnouncements\\Cron\\Crawler','null',1594901117,1594903857,0,11),(19,'OCA\\Files\\BackgroundJob\\ScanFiles','null',1594903976,1594903976,0,5),(20,'OCA\\Files\\BackgroundJob\\DeleteOrphanedItems','null',1594901263,1594904006,0,0),(21,'OCA\\Files\\BackgroundJob\\CleanupFileLocks','null',1594904015,1594904015,0,0),(22,'OCA\\Files\\BackgroundJob\\CleanupDirectEditingTokens','null',1594904026,1594904026,0,0),(23,'OCA\\Support\\BackgroundJobs\\CheckSubscription','null',1594904038,1594904038,0,1),(24,'OC\\Authentication\\Token\\DefaultTokenCleanupJob','null',1594904047,1594904046,0,0),(25,'OC\\Log\\Rotate','null',1594966589,1594966589,0,0),(26,'OC\\Preview\\BackgroundCleanupJob','null',1594966602,1594966602,0,0),(27,'OCA\\Richdocuments\\Backgroundjobs\\ObtainCapabilities','null',1594902996,1595009890,0,0),(28,'OCA\\Talk\\BackgroundJob\\ExpireSignalingMessage','null',1594966690,1594966690,0,0),(29,'OCA\\Talk\\BackgroundJob\\RemoveEmptyRooms','null',1594966702,1594966702,0,0),(30,'OCA\\Talk\\BackgroundJob\\ResetAssignedSignalingServer','null',1594966720,1594966720,0,0),(33,'OCA\\User_LDAP\\Jobs\\UpdateGroups','null',1594967769,1594967769,0,0),(34,'OCA\\User_LDAP\\Jobs\\CleanUp','null',1594967973,1594967973,0,3),(35,'OCA\\User_LDAP\\Jobs\\Sync','null',1594903847,1594903847,0,0),(38,'OC\\Command\\CommandJob','\"O:33:\\\"OCA\\\\Files_Trashbin\\\\Command\\\\Expire\\\":1:{s:39:\\\"\\u0000OCA\\\\Files_Trashbin\\\\Command\\\\Expire\\u0000user\\\";s:15:\\\"nextcloud_admin\\\";}\"',0,1594966645,0,0);
...
CREATE TABLE `oc_mail_messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `message_id` varchar(1024) COLLATE utf8mb4_bin DEFAULT NULL,
...
INSERT INTO `oc_mimetypes` VALUES (3,'application'),(14,'application/javascript'),(4,'application/json'),(15,'application/octet-stream'),(6,'application/pdf'),(21,'application/vnd.oasis.opendocument.presentation-template'),(20,'application/vnd.oasis.opendocument.spreadsheet-template'),(19,'application/vnd.oasis.opendocument.text-template'),(5,'application/vnd.openxmlformats-officedocument.wordprocessingml.document'),(16,'application/x-gzip'),(1,'httpd'),(2,'httpd/unix-directory'),(9,'image'),(13,'image/jpeg'),(10,'image/png'),(18,'image/svg+xml'),(7,'text'),(17,'text/css'),(22,'text/html'),(8,'text/markdown'),(11,'video'),(12,'video/mp4');
...
('{{ ADMIN_USER }}','activity','configured','yes'),('{{ ADMIN_USER }}','avatar','generated','true'),('{{ ADMIN_USER }}','core','lang','{{ DEFAULT_LANG }}'),('{{ ADMIN_USER }}','core','locale','{{ DEFAULT_LANG }}'),('{{ ADMIN_USER }}','core','timezone','Europe/Madrid'),('{{ ADMIN_USER }}','firstrunwizard','apphint','18'),('{{ ADMIN_USER }}','firstrunwizard','show','0'),('{{ ADMIN_USER }}','login','lastLogin',''),('{{ ADMIN_USER }}','login_token','',''),('{{ ADMIN_USER }}','password_policy','failedLoginAttempts','0'),('{{ ADMIN_USER }}','spreed','changelog','19'),('{{ ADMIN_USER }}','spreed','signaling_ticket_secret','qKrM5Z+x/BmoZ9H86XhJQ7OBSXyUjOixiP6JnKfpckCp6+5DFREkykCVa63IBpFvZK2HTbcHVeCQDyyIBOgE5QTED+vm2VkgiD1xP8Ym9LfQwUx5cMUpKsgq9DiKAT5Ypv/vSL5ZqE5XgBkK+D1ppJD2lUQuh4OQDTeTfD0r+ojohqimiSAqy9dVodV5WgdsOyxgzlTTV73ZniLLKdLRhXjOr/i+wuFTvoAVS6NAHAi7uBsxpYU3dnQCadja48s');
...
-- Dump completed on 2020-07-17  8:40:43
